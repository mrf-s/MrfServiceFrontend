...
export class StubReviewsProviderService implements ReviewsProvider {
  private reviews: ReviewModel[] = [
    ...
    },
    {
      ...
      message: 'На ремонт предоставляет гарантию.\n' +
        'На время ремонта выдаёт приличный телефон для связи.\n' +
        'Запасные части для различных смартфонов.\n' +
        'После диагностики озвучивает сумму ремонта.\n' +
        'Среди множества ремонтных мастерских - самая лучшая.\n' +
        'Заменил стекло, продезинфицировал телефон внутри и снаружи.\n' +
        'В других сервисах за замену стекла в разы дороже просили.\n' +
        'Всё надёжно и можно ещё и документы отсканировать.'
    },
  ];
